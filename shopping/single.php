                ...
                <div class="col-md-6">
                    <div class="product p-4">
                        ...
                        <form method="POST" id="form-data">
                            ...
                            <div class="">
                                <input type="hidden" class="form-control" value="<?php echo $product->id; ?>" name="pro_id">
                            </div>
                            <div class="">
                                <input type="hidden" class="form-control" name="pro_name" value="<?php echo $product->name; ?>">
                            </div>
                            <div class="">
                                <input type="hidden" class="form-control" name="pro_image" value="<?php echo $product->image; ?>">
                            </div>
                            <div class="">
                                <input type="hidden" class="form-control" name="pro_price" value="<?php echo $product->price; ?>">
                            </div>
                            <div class="">
                                <input type="hidden" class="form-control" name="pro_amount" value="1">
                            </div>
                            <div class="">
                                <input type="hidden" class="form-control" name="pro_file" value="<?php echo $product->file; ?>">
                            </div>
